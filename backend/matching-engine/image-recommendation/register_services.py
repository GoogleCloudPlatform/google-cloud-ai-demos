...
def register_services() -> Dict[str, match_service.MatchService]:
    ...
    try:
        with tracer.start_span("text_match_service_instance init"):
    ...
    try:
        with tracer.start_span("stackoverflow_questions_match_service_instance init"):
            stackoverflow_questions_match_service_instance = sentence_transformer_service.SentenceTransformer(
    ...
    try:
        with tracer.start_span("text_to_image_match_service_instance init"):
